package com.hyq.wx.services.common.error;

/**
 * @author nanke
 * @date 2020/10/30 3:21 下午
 * 致终于来到这里的勇敢的人:
...
public enum WxCpErrorEnum {
    ...
    WxCpErrorEnum(int code, String msg) {
        this.code = code;
        this.msg = msg;
    }
    ...
    public static String findMsgByCode(int code) {
        for (WxCpErrorEnum value : WxCpErrorEnum.values()) {
            if (value.code == code) {
                return value.msg;
            }
        }
